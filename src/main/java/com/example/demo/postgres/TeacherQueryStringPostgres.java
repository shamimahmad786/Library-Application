...
public static String QRTeacherByAppontmentNature_128(String strType, String StrCode, Integer yearId) {
	...
	try {
		...
		case "N" :
			...
			strQuery.append(" sum(total_teacher) FILTER (WHERE tp.nature_of_appt = 1 and gender = 2  ) AS regular , "  );
			strQuery.append(" sum(total_teacher) FILTER (WHERE tp.nature_of_appt = 2 and gender = 2  ) AS contract  , "  );
			strQuery.append(" sum(total_teacher) FILTER (WHERE tp.nature_of_appt = 3 and gender = 2  ) AS partime , "  );
			strQuery.append(" sch_mgmt_id ,  "  );
			strQuery.append(" sch_mgmt_name,  "  );
			strQuery.append(" sch_category_name , "  );
